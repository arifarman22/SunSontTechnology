              ...
              <div key={product.id} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-200">
                ...
                <div className="p-3">
                  <div className="mb-2">
                    ...
                    <span className="text-xs bg-yellow-600/10 text-yellow-600 px-2 py-0.5 rounded-full font-semibold inline-block mt-1">
                      {product.model}
                    </span>
                  </div>
                    ...
                    <ul className="space-y-1">
                      {product.features.slice(0, 3).map((feature, index) => (
                        <li key={index} className="flex items-center text-xs text-gray-600">
                          <div className="w-1.5 h-1.5 bg-yellow-600 rounded-full mr-2 flex-shrink-0"></div>
                  ...
                  <button 
                    className="w-full bg-yellow-600 hover:bg-yellow-700 text-white py-2 rounded font-semibold transition-colors text-sm"
