              ...
              <Card key={product.id} className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardHeader className="p-3">
                  <CardTitle className="text-lg line-clamp-2 flex items-start justify-between gap-2">
                    ...
                    <span className="text-xs bg-indigo-600/10 text-indigo-600 px-2 py-0.5 rounded-full whitespace-nowrap flex-shrink-0">
                      {product.model}
                    </span>
                  </CardTitle>
                ...
                <CardContent className="space-y-3 p-3 pt-0">
                  ...
                  <button 
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg font-semibold transition-colors text-sm"
